...
assert.match(worker, /const CACHE_NAME = 'rio-das-mortes-google-v3';/,
  'the Google cache identity must preserve the partial field download');
...
const context = {
  ...
  caches: {
    ...
    async keys() { return ['rio-das-mortes-google-v3']; },
...
console.log('Google worker regression tests passed');
